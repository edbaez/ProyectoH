    ...
    switch( cmd)  
    {
      ...
      case 'B':
      {
        if(atoi(msj+1)==1)
        {
          ...
          control_bomba_manual = 1        ;// enciende 
          }
        else  
        {
          APAGAR_BOMBA;
      ...
      case 'T': Serial.println (T_on=(double)SEG*atoi(msj+1)) ;break;
      case 'U': Serial.println (Tau= (double)MIN*atoi(msj+1)) ;break;
...
#define tiempo_de_encendido  
  void control_riego()
  {
    if(((millis()%Tau <= T_on)or control_bomba_manual)&IF_AGUA) ENCENDER_BOMBA
    else APAGAR_BOMBA
  }
// ............................................ 
